...
func TestSaveUser(t *testing.T) {
	...
	assert.Equal(t, newUser.BirthDate, savedUser.BirthDate)
}
...
func TestGetUserByID(t *testing.T) {
	...
	assert.Equal(t, foundUser.BirthDate, user.BirthDate)
}
...
func TestUpdateAUser(t *testing.T) {
	...
	assert.Equal(t, updatedUser.BirthDate, userUpdate.BirthDate)
}
